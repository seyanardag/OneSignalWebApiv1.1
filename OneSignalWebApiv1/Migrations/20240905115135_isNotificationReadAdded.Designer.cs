...
namespace OneSignalWebApiv1.Migrations
{
    ...
    [Migration("20240905115135_isNotificationReadAdded")]
    partial class isNotificationReadAdded
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OneSignalWebApiv1.Entities.Homework", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CREATEDDATE = new DateTime(2024, 9, 5, 14, 56, 35, 12, DateTimeKind.Local).AddTicks(583),
                            CREATEDTIME = new TimeSpan(537950120587),
                            HomeworkTitle = "Matematik 5 soru çöz"
                        },
                        new
                        {
                            GUID = new Guid("d8a89b58-0db8-4f62-a6b5-dc5a2e3de0a3"),
                            CREATEDDATE = new DateTime(2024, 9, 5, 15, 1, 35, 12, DateTimeKind.Local).AddTicks(589),
                            CREATEDTIME = new TimeSpan(537950120590),
            ...
            modelBuilder.Entity("OneSignalWebApiv1.Entities.Student", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CREATEDDATE = new DateTime(2024, 9, 5, 0, 0, 0, 0, DateTimeKind.Local),
                            CREATEDTIME = new TimeSpan(534950120485),
                            StudentName = "Ali"
                        },
                        new
                        {
                            ...
                            CREATEDDATE = new DateTime(2024, 9, 5, 0, 0, 0, 0, DateTimeKind.Local),
                            CREATEDTIME = new TimeSpan(534950120496),
                            StudentName = "Ayşe"
                        },
                        new
                        {
                            ...
                            CREATEDDATE = new DateTime(2024, 9, 5, 0, 0, 0, 0, DateTimeKind.Local),
                            CREATEDTIME = new TimeSpan(534950120499),
                            StudentName = "Ahmet"
                        });
                });
